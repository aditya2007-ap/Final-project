  ...
  return (
    <div className="about-page py-5 bg-light">
      <div className="container">
        ...
        <div className="row align-items-center mb-5 bg-white p-4 p-md-5 rounded-4 shadow-sm" data-aos="fade-up" data-aos-duration="900">
          ...
          <div className="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div className="row g-3 text-center">
              ...
              <div className="col-6" data-aos="zoom-in" data-aos-delay="600">
